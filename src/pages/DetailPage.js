...
const DetailPage = ({departments}) => {
        ...
        const [detail, setDetail] = useState({
            id: '',
            content: '이미 판매되었거나 존재하지 않는 책입니다.',
            connect: '',
            date: '2022-09-24T15:27:45',
            view: '',
            lecture: {id: '', title: '', departmentId: '1'},
            book: {author: '', code: '', id: '', publisher: '', thumbnail: '', title: '이미 판매되었거나 존재하지 않는 책입니다.'},
            member: {id: '', nickname: '없는 페이지', password: '', memberId: '', email: '', authority: ''}
        });
        const [detailDepartments, setDetailDepartments] = useState([]);
        ...
        useEffect(() => {
            if (location.state !== null) {
                ...
                setPathId(location.pathname.split('/')[2])
