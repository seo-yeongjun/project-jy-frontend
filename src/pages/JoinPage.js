                ...
                <div>
                    ...
                    <div className="flex w-full">
                        <input type="text" id="memberId"
                               className=" bg-amber-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-amber-50 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                               placeholder="아이디 입력" required=""/>
                        <button className="w-1/5 border rounded ml-2 bg-blue-300 text-white text-sm hover:bg-blue-200">중복 확인</button>
                    </div>
                </div>
                <div>
